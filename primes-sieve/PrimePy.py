...
class prime_sieve(object):
    ...
    primeCounts = { 10: 1, 100: 25, 1000: 168, 10000: 1229, 100000: 9592, 1000000: 78498, 10000000: 664579, 100000000: 5761455 }
        ...
        while (factor < q):
            for num in range (factor, this.sieveSize):
                if (this.GetBit(num) == True):
                    factor = num
                    break
            #   If marking factor 3, you wouldn't mark 6 (it's a mult of 2) so start with the 3rd instance of this factor's multiple.  We can then step by factor * 2 because every second one is going to be even by definition
    ...
    def printResults(this, showResults):
...
sieve = prime_sieve(20)                        #   Calc the primes up to a million
...
sieve.printResults(True)                   #   Display outcome
